...
class MainActivity : AppCompatActivity() {
    ...
    var adapterS: SerieAdapter? = null
...
class PeliculaAdapter: BaseAdapter {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vista.imgPelicula.setImageResource(pelicula.img)
        vista.tituloPelicula.setText(pelicula.titulo)

        vista.imgPelicula.setOnClickListener(){
            var intent = Intent(context, DetallePelicula::class.java)
            intent.putExtra("nombre", pelicula.titulo)
            intent.putExtra("image", pelicula.img)
