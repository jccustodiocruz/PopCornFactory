...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addPeliculas()
        adapterP= adapter(this, peliculas)
        gridPeliculas.adapter=adapterP

        addSeries()
        adapterS= adapter(this,series)
...
class adapter: BaseAdapter {
    ...
    constructor(context: Context, movies:ArrayList<Pelicula>){
